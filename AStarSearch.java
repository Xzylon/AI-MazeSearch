...
public class AStarSearch {
    ...
    public ArrayList<Node> doAStarSearch() {
    	...
    	frontierArray.add(maze.start);
   		...
   		while ( !frontierArray.isEmpty() ) {
        	...
        	printModdedMaze(maze, frontierArray);
            ...
            if ( maze.canMove(maze, currentNode, "north") && !northNode.checked ) { 
                ...
                for (int counter=0; counter < frontierArray.size(); counter++) {
                	if ( northNode.x == frontierArray.get(counter).x && 
                   	     northNode.y == frontierArray.get(counter).y ) {
            ...
            if ( maze.canMove(maze, currentNode, "east") && !eastNode.checked ) { 
                ...
                for (int counter=0; counter < frontierArray.size(); counter++) {
                	if ( eastNode.x == frontierArray.get(counter).x && 
                   	     eastNode.y == frontierArray.get(counter).y ) {
            ...
            if ( maze.canMove(maze, currentNode, "south") && !southNode.checked ) { 
                ...
                for (int counter=0; counter < frontierArray.size(); counter++) {
                	if ( southNode.x == frontierArray.get(counter).x && 
                   	     southNode.y == frontierArray.get(counter).y ) {
            ...
            if ( maze.canMove(maze, currentNode, "west") && !westNode.checked ) { 
                ...
                for (int counter=0; counter < frontierArray.size(); counter++) {
                	if ( westNode.x == frontierArray.get(counter).x && 
                   	     westNode.y == frontierArray.get(counter).y ) {
    ...
    public void printModdedMaze(Maze inMaze, ArrayList<Node> frontier) {
    	moddedMaze = inMaze;
